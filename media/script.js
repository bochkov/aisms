function copyright() {
    ...
    if (year > 2011) document.write("2010-");
    document.write(year + " &copy; Бочков Сергей Александрович")
}

var arrowimages = {
    down:['downarrowclass', 'http://127.0.0.1:8000/media/down.png', 23],
    right:['rightarrowclass', 'http://127.0.0.1:8000/media/right.png']};
